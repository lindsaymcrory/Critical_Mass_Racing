...
(Coach Says / Rig Tune / Hull Analysis / Videos / About) and a main content area listing every
...
<div class="layout">
  <nav>
    ...
    <a class="nav-btn about-btn" href="/rig-tune">Rig Tune<span class="hint">Tuning &amp; Maintenance Log</span></a>
    <a class="nav-btn about-btn" href="/hull-analysis">Hull Analysis<span class="hint">Speed &amp; Bottom</span></a>
