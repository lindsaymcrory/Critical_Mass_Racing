...
Reports are authored by hand in a Claude session (see COACH_SYSTEM_PROMPT for
the analysis template) rather than generated by a live API call -- there is
no API-key dependency here. summarize_race_data() is the entry point for
